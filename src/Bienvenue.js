...
function Bienvenue() {
  ...
  const categories = ["Tous", "Vêtements", "Chaussures", "Accessoires", "Soins", "Biberons", "Sacs"];
  ...
  const produitsFiltres = produitsFirebase.filter((produit) => {
    ...
    <div className="App">
      ...
      <section className="coup-coeur-section">
        ...
        <div className="coup-coeur-card">
          <div className="coup-coeur-text">
            ...
            <p>Chaque collection est pensée pour apporter douceur, élégance et confort aux enfants.</p>
      ...
      <section className="stats-section">
        <div className="stats-grid">
          <div className="stat-card"><h2>500+</h2><p>Articles bébé</p></div>
          <div className="stat-card"><h2>100%</h2><p>Clients satisfaits</p></div>
          <div className="stat-card"><h2>24h</h2><p>Réponse WhatsApp</p></div>
          <div className="stat-card"><h2>0-11</h2><p>Ans disponibles</p></div>
        </div>
      </section>
